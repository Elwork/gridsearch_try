public class SEIRParameterGridSearch {
	private static final double START_ALPHA = 0;
	private static final double END_ALPHA = 0.00378071;
	private static final double START_BETA = 0.05;
	private static final double END_BETA = 1.0;
	private static final double START_INCUBATION_PERIOD = 5.9;
	private static final double END_INCUBATION_PERIOD = 7.1;
	private static final double START_INFECTIOUS_PERIOD = 7.0;
	private static final double END_INFECTIOUS_PERIOD = 10.0;
